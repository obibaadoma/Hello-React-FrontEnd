...
> Hello-React-FrontEnd is a project that aims to connect a Ruby on Rails back-end with a [React front-end](https://github.com/obibaadoma/Hellol-React-FrontEnd/tree/project-setup-and-front).
